...
const Features = ()=> {
    ...
    return (
        <div id='features' className='flex flex-col item-center my-10 scroll-mt-12 justify-center'>
    ...
    <div className='flex items-center justify-center flex-col'>
        ...
        <Title title={'Build Your resume'} description={"Our streamlined process helps you create a professional resume in minutes with AI-powered tools features."}/>
    </div>
